...
class Two_Factor_GPG extends Two_Factor_Provider
{
     ...
     * @param $key : a public key input from the user.
     * @return string a key without first 3 lines and last line
     */
    ...
    public function ajax_set_key()
    {
        ...
        wp_send_json_success(array('key' => 'Public key set successfully'));
    }
    ...
    public function encrypt_token($token, $key)
    {
        ...
        $pub_key = new nicoSWD\GPG\PublicKey($key);
